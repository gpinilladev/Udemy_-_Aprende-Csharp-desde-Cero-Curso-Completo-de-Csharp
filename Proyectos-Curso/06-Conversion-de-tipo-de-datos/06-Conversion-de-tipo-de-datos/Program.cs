...
namespace _06_Conversion_de_tipo_de_datos
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            // Podemos convertir explicitamente usando try-catch y seria de esta manera:
            try
            {
        ...
        public static void cw(string variable, string tab)
        {
            Console.WriteLine(variable);
            Console.WriteLine(Separator(tab));
